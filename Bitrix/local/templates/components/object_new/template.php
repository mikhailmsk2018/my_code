...
//if( $USER->IsAdmin() ){
//echo '<pre>'; 
//var_dump($arResult['PROPERTIES']['AREA']['VALUE']); 
//echo '</pre>';
//} 
?>
		...
		<div class="container">
            ...
            <div class="col-sm-12 col-md-9">
                ...
                <div class="col-sm-3 hidden-xs hidden-sm">
                    <img class="img" style="width: 150px; height: 340px;" src="/local/templates/uniservis/components/bitrix/news.detail/object_new/img/leftImg.png" alt="" />
                </div>
                <div class="col-sm-3">
                <div class="row hidden-xs hidden-sm" style="margin-top: 10px;">
                   
                   <? if($arResult['PROPERTIES']['facebook']['VALUE'] != ""){?>
                   <div class="col-sm-1 otstup4">
						<?if($arResult['PROPERTIES']['facebook']['VALUE']):?>
						<div class="line line-sm">
							<a class="lfb-link" href="<?=$arResult['PROPERTIES']['facebook']['VALUE']?>" target="_blank"><img class="social" src="/local/templates/uniservis/components/bitrix/news.detail/object_new/img/facebook.png" alt="" /></a>
						</div>
						<?endif?>
                        </div>
                       <?}?> 
                    <div class="col-sm-2 otstup3">    
						<?if($arResult['PROPERTIES']['instagram']['VALUE']):?>
						<div class="line line-sm">
							<a class="lig-link" href="<?=$arResult['PROPERTIES']['instagram']['VALUE']?>" target="_blank"><img class="social" src="/local/templates/uniservis/components/bitrix/news.detail/object_new/img/instagram.png" alt="" /></a>
						</div>
						<?endif?>
					</div>	
                    </div>    
